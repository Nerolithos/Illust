...
const selections = [
 ...
 ['IMG_6465','Myrtle','红发少女与暖色光影'], // 02
 ['IMG_2548','Rosmontis in Gown','云海中的银发少女'], // 03
 ['IMG_9984','Koishi','街角、黑猫与一束日光'], // 04
 ['IMG_0345','Cecilia','草地上的少女肖像'], // 05
 ['IMG_7079','Tsugu','黑色贝雷帽与柔和目光'], // 06
 ['IMG_8195','Weedy','圆月前的角色插画'], // 07
 ['IMG_7838','The Blue Devil','蓝白色角色习作'], // 08
 ['IMG_7670','Thumpy','抱着披萨的兔耳少女'], // 09
 ['IMG_3631','Miyu','树影中的蓝衣少女'], // 10
 ['IMG_5382','Huizhou Daybreak','暮色海岸与远方的云'], // 11
 ['IMG_2398','Tachibana Sherry','室内场景中的蓝发少女'], // 12
 ['IMG_4827','Hilda','柔光下的角色肖像'], // 13
 ['IMG_4315','La Pluma','清澈水面与夏日少女'], // 14
 ['IMG_5679','Lappland','银发角色服装习作'], // 15
 ['IMG_4153','Rosmontis','蓝色外套与白发少女'], // 16
 ['IMG_3574','Kei','粉色背景中的角色习作'], // 17
 ['IMG_9449','Not a Dog','粉发少女肖像'], // 18
 ['IMG_8209','Ryuuu','黑色尖帽与绿色眼睛'], // 19
 ['IMG_4889','Alice','青色背景中的角色肖像'], // 20
 ['IMG_2744','Cynisca','蓝白服饰角色插画'], // 21
