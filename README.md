...
React / Vinext 静态作品集，包含 28 幅本地插画、响应式画廊与可键盘操作的大图浏览。
...
作品库仅加载 `public/images` 中的 WebP：28 幅作品各有 480、960、1600 像素长边版本，以及头像和图标，共 86 个文件。根目录原始素材不会进入静态输出。浏览器图标单独使用 `public/favicon.ico`。
