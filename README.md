...
React / Vinext 静态作品集，包含 27 幅本地插画、响应式画廊与可键盘操作的大图浏览。
...
仅保留 `public/images` 中的 WebP：27 幅作品各有 480、960、1600 像素长边版本，以及头像和图标，共 83 个文件。原始 JPG/PNG 已按要求删除。浏览器图标单独使用 `public/favicon.ico`。
